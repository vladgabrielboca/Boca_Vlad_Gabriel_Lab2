...
options.UseSqlServer(builder.Configuration.GetConnectionString("Boca_Vlad_Gabriel_Lab2Context") ?? throw new 
InvalidOperationException("Connection string Boca_Vlad_Gabriel_Lab2Context not found.")));
